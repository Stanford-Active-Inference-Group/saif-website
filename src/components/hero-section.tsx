  ...
  return (
    <section className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
            <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="/saif_logo.png"/>
            ...
            <p className="mb-8 leading-relaxed">The Stanford Active Inference Group provides a space for learning and applying Active Inference, a rapidly emerging formalism for intelligent systems.
          ...
          If you are interested in learning more, sign up to our mailing list!</p>
            <div className="flex w-full justify-center items-end">
                ...
                <a 
                href="https://mailman.stanford.edu/mailman/listinfo/inferactively" 
                className="inline-flex items-center text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg"
                target="_blank" 
